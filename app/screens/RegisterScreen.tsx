import { Button, InputAccessoryView, Text, TextInput, TouchableOpacity } from "react-native"
        ...
        <View className="flex flex-col pt-[60px] px-4 text-white gap-y-2">
          <Controller
            ...
            render={({ field: { onChange, onBlur, value } }) => (
              <TextInput
                className="rounded-full border border-white/10 p-4 text-white/70  placeholder:text-white/70"
                onBlur={onBlur}
